<template>
    ...
    <div class="room-details">
      ...
      <div class="btns">
        <button @click="confirmDelete" class="btn">Delete this room</button>
        <button @click="addImage" class="btn">Add Images</button>
      </div>
...
import Navbar from '../Navbar.vue';
  export default {
    ...
    methods: {
      ...
      addImage(){
        this.$router.push(`/admin/add-image/${this.roomId}`);
      },
      confirmDelete(){
        if(confirm('Do you confirm to delete this room?')){
            this.deleteRoom();
        }
      },
      deleteRoom(){
        axios.delete(`/api/room/delete/${this.roomId}`)
        .then((response) =>{
